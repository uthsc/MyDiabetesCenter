...
<div id="content" class="row">
    <div class="columns" data-equalizer="test">
        ...
        <p>Check out these great materials selected by diabetes experts and patients living with diabetes:</p>
        <div class="row panel text-center">
            <h2 class="text-left">Physical Activity</h2>
        ...
        <div class="row panel text-center">
            <h2 class="text-left">Caring for Diabetes</h2>
